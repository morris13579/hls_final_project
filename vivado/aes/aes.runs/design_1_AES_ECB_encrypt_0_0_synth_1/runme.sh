...
HD_PWD='C:/Users/Morris/Desktop/HighLevelSynthesis_AES/vivado/aes/aes.runs/design_1_AES_ECB_encrypt_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_AES_ECB_encrypt_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_AES_ECB_encrypt_0_0.tcl
