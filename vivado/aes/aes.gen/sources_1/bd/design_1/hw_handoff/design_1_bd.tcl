...
proc create_root_design { parentCell } {
  ...
  # Create instance: Cipher_Stream_0, and set properties
  set Cipher_Stream_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:Cipher_Stream:1.0 Cipher_Stream_0 ]
  ...
  connect_bd_intf_net -intf_net Cipher_Stream_0_out_V [get_bd_intf_pins Cipher_Stream_0/out_V] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net axi_dma_1_M_AXIS_MM2S [get_bd_intf_pins Cipher_Stream_0/in_V] [get_bd_intf_pins axi_dma_1/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins Cipher_Stream_0/s_axi_control] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  ...
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Cipher_Stream_0/s_axi_control/Reg] -force
