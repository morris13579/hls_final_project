...
// ==============================================================
`timescale 1 ns / 1 ps
module Cipher_Stream_SubBytes385_S_Box429_rom (
...
initial begin
    $readmemh("./Cipher_Stream_SubBytes385_S_Box429_rom.dat", ram0);
    $readmemh("./Cipher_Stream_SubBytes385_S_Box429_rom.dat", ram1);
    $readmemh("./Cipher_Stream_SubBytes385_S_Box429_rom.dat", ram2);
    $readmemh("./Cipher_Stream_SubBytes385_S_Box429_rom.dat", ram3);
    $readmemh("./Cipher_Stream_SubBytes385_S_Box429_rom.dat", ram4);
    $readmemh("./Cipher_Stream_SubBytes385_S_Box429_rom.dat", ram5);
    $readmemh("./Cipher_Stream_SubBytes385_S_Box429_rom.dat", ram6);
    $readmemh("./Cipher_Stream_SubBytes385_S_Box429_rom.dat", ram7);
end
...
`timescale 1 ns / 1 ps
module Cipher_Stream_SubBytes385_S_Box429(
    reset,
    clk,
    address0,
    ce0,
...
Cipher_Stream_SubBytes385_S_Box429_rom Cipher_Stream_SubBytes385_S_Box429_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
