...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module SubBytes_sbox_V_rom (
...
initial begin
    $readmemh("./SubBytes_sbox_V_rom.dat", ram0);
    $readmemh("./SubBytes_sbox_V_rom.dat", ram1);
    $readmemh("./SubBytes_sbox_V_rom.dat", ram2);
    $readmemh("./SubBytes_sbox_V_rom.dat", ram3);
    $readmemh("./SubBytes_sbox_V_rom.dat", ram4);
    $readmemh("./SubBytes_sbox_V_rom.dat", ram5);
    $readmemh("./SubBytes_sbox_V_rom.dat", ram6);
    $readmemh("./SubBytes_sbox_V_rom.dat", ram7);
end
