// ==============================================================
// File generated on Thu Dec 30 11:32:04 +0800 2021
...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module SubBytes101_sbox_bkb_rom (
...
initial begin
    $readmemh("./SubBytes101_sbox_bkb_rom.dat", ram0);
    $readmemh("./SubBytes101_sbox_bkb_rom.dat", ram1);
    $readmemh("./SubBytes101_sbox_bkb_rom.dat", ram2);
    $readmemh("./SubBytes101_sbox_bkb_rom.dat", ram3);
    $readmemh("./SubBytes101_sbox_bkb_rom.dat", ram4);
    $readmemh("./SubBytes101_sbox_bkb_rom.dat", ram5);
    $readmemh("./SubBytes101_sbox_bkb_rom.dat", ram6);
    $readmemh("./SubBytes101_sbox_bkb_rom.dat", ram7);
end
...
SubBytes101_sbox_bkb_rom SubBytes101_sbox_bkb_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
