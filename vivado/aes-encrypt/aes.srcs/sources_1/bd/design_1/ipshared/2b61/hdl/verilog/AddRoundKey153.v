...
output  [3:0] RoundKey_V10_address0;
output   RoundKey_V10_ce0;
input  [7:0] RoundKey_V10_q0;
...
reg[7:0] out_V_15;
reg out_V_15_ap_vld;
reg[3:0] RoundKey_V10_address0;
reg RoundKey_V10_ce0;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state16)) begin
        RoundKey_V10_address0 = 64'd15;
    end else if ((1'b1 == ap_CS_fsm_state15)) begin
        RoundKey_V10_address0 = 64'd14;
    end else if ((1'b1 == ap_CS_fsm_state14)) begin
        RoundKey_V10_address0 = 64'd13;
    end else if ((1'b1 == ap_CS_fsm_state13)) begin
        RoundKey_V10_address0 = 64'd12;
    end else if ((1'b1 == ap_CS_fsm_state12)) begin
        RoundKey_V10_address0 = 64'd11;
    end else if ((1'b1 == ap_CS_fsm_state11)) begin
        RoundKey_V10_address0 = 64'd10;
    end else if ((1'b1 == ap_CS_fsm_state10)) begin
        RoundKey_V10_address0 = 64'd9;
    end else if ((1'b1 == ap_CS_fsm_state9)) begin
        RoundKey_V10_address0 = 64'd8;
    end else if ((1'b1 == ap_CS_fsm_state8)) begin
        RoundKey_V10_address0 = 64'd7;
    end else if ((1'b1 == ap_CS_fsm_state7)) begin
        RoundKey_V10_address0 = 64'd6;
    end else if ((1'b1 == ap_CS_fsm_state6)) begin
        RoundKey_V10_address0 = 64'd5;
    end else if ((1'b1 == ap_CS_fsm_state5)) begin
        RoundKey_V10_address0 = 64'd4;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        RoundKey_V10_address0 = 64'd3;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        RoundKey_V10_address0 = 64'd2;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        RoundKey_V10_address0 = 64'd1;
    end else if ((1'b1 == ap_CS_fsm_state1)) begin
        RoundKey_V10_address0 = 64'd0;
    end else begin
        RoundKey_V10_address0 = 'bx;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state16) | (1'b1 == ap_CS_fsm_state15) | (1'b1 == ap_CS_fsm_state14) | (1'b1 == ap_CS_fsm_state13) | (1'b1 == ap_CS_fsm_state12) | (1'b1 == ap_CS_fsm_state11) | (1'b1 == ap_CS_fsm_state10) | (1'b1 == ap_CS_fsm_state9) | (1'b1 == ap_CS_fsm_state8) | (1'b1 == ap_CS_fsm_state7) | (1'b1 == ap_CS_fsm_state6) | (1'b1 == ap_CS_fsm_state5) | (1'b1 == ap_CS_fsm_state4) | (1'b1 == ap_CS_fsm_state3) | (1'b1 == ap_CS_fsm_state2) | (~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1)))) begin
        RoundKey_V10_ce0 = 1'b1;
    end else begin
        RoundKey_V10_ce0 = 1'b0;
    end
end
...
assign ret_V_10_fu_537_p2 = (in_V_10 ^ RoundKey_V10_q0);

assign ret_V_11_fu_544_p2 = (in_V_11 ^ RoundKey_V10_q0);

assign ret_V_12_fu_551_p2 = (in_V_12 ^ RoundKey_V10_q0);

assign ret_V_13_fu_558_p2 = (in_V_13 ^ RoundKey_V10_q0);

assign ret_V_14_fu_565_p2 = (in_V_14 ^ RoundKey_V10_q0);

assign ret_V_1_fu_474_p2 = (in_V_1 ^ RoundKey_V10_q0);

assign ret_V_2_fu_481_p2 = (in_V_2 ^ RoundKey_V10_q0);

assign ret_V_3_fu_488_p2 = (in_V_3 ^ RoundKey_V10_q0);

assign ret_V_4_fu_495_p2 = (in_V_4 ^ RoundKey_V10_q0);

assign ret_V_5_fu_502_p2 = (in_V_5 ^ RoundKey_V10_q0);

assign ret_V_6_fu_509_p2 = (in_V_6 ^ RoundKey_V10_q0);

assign ret_V_7_fu_516_p2 = (in_V_7 ^ RoundKey_V10_q0);

assign ret_V_8_fu_523_p2 = (in_V_8 ^ RoundKey_V10_q0);

assign ret_V_9_fu_530_p2 = (in_V_9 ^ RoundKey_V10_q0);

assign ret_V_fu_467_p2 = (in_V_0 ^ RoundKey_V10_q0);

assign ret_V_s_fu_572_p2 = (in_V_15 ^ RoundKey_V10_q0);

endmodule //AddRoundKey153
