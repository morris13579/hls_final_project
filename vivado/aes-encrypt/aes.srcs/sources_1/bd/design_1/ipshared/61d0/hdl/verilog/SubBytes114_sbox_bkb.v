// ==============================================================
// File generated on Thu Jan 06 10:09:49 +0800 2022
...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module SubBytes114_sbox_bkb_rom (
...
initial begin
    $readmemh("./SubBytes114_sbox_bkb_rom.dat", ram0);
    $readmemh("./SubBytes114_sbox_bkb_rom.dat", ram1);
    $readmemh("./SubBytes114_sbox_bkb_rom.dat", ram2);
    $readmemh("./SubBytes114_sbox_bkb_rom.dat", ram3);
    $readmemh("./SubBytes114_sbox_bkb_rom.dat", ram4);
    $readmemh("./SubBytes114_sbox_bkb_rom.dat", ram5);
    $readmemh("./SubBytes114_sbox_bkb_rom.dat", ram6);
    $readmemh("./SubBytes114_sbox_bkb_rom.dat", ram7);
end
...
SubBytes114_sbox_bkb_rom SubBytes114_sbox_bkb_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
