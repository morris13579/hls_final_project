...
// wrapc file define:
#define AUTOTB_TVIN_length "../tv/cdatafile/c.AES_ECB_encrypt.autotvin_length_r.dat"
#define AUTOTB_TVOUT_length "../tv/cdatafile/c.AES_ECB_encrypt.autotvout_length_r.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_length "../tv/rtldatafile/rtl.AES_ECB_encrypt.autotvout_length_r.dat"
...
extern "C" void apatb_AES_ECB_encrypt_hw(volatile void * __xlx_apatb_param_plain, volatile void * __xlx_apatb_param_encrypt, volatile void * __xlx_apatb_param_key, long long __xlx_apatb_param_length) {
...
// print key Transactions
{
  ...
  {
    sc_bv<8> __xlx_tmp_lv = *((char*)__xlx_apatb_param_key);
...
// print length Transactions
{
  ...
  {
    sc_bv<64> __xlx_tmp_lv = *((long long*)&__xlx_apatb_param_length);
...
AES_ECB_encrypt_hw_stub_wrapper(__xlx_apatb_param_plain, __xlx_apatb_param_encrypt, __xlx_apatb_param_key, __xlx_apatb_param_length);
