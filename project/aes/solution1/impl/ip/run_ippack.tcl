...
set Library     "hls"
set IPName      "Cipher_Stream"
set Version     "1.0"
set DisplayName "Cipher_stream"
set Revision    "2112292153"
...
set xo_kernel_name "Cipher_Stream"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/Users/Morris/Desktop/HighLevelSynthesis_AES/project/aes/solution1"
set debug_dir "C:/Users/Morris/Desktop/HighLevelSynthesis_AES/project/aes/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {Cipher_Stream_SubBytes385_S_Box429
Cipher_Stream_fifo_w8_d2_S
Cipher_Stream_fifo_w8_d2_S
Cipher_Stream_fifo_w8_d2_S
Cipher_Stream_fifo_w8_d2_S
Cipher_Stream_fifo_w8_d2_S
...
## Variables
set Top "Cipher_Stream"
set TopNoPrefix "Cipher_Stream"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0xc0 length_r_1 W 0x0 "Data signal of length_r" {{0 32 length_r W 0 "Bit 31 to 0 of length_r"}}} {0xc4 length_r_2 W 0x0 "Data signal of length_r" {{0 32 length_r W 0 "Bit 63 to 32 of length_r"}}}}
        memories "w_0 {base_address 16 range 16} w_1 {base_address 32 range 16} w_2 {base_address 48 range 16} w_3 {base_address 64 range 16} w_4 {base_address 80 range 16} w_5 {base_address 96 range 16} w_6 {base_address 112 range 16} w_7 {base_address 128 range 16} w_8 {base_address 144 range 16} w_9 {base_address 160 range 16} w_10 {base_address 176 range 16}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    ap_clk {
        ...
        buses "s_axi_control in_V out_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
