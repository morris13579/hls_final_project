...
architecture behave of AES_ECB_encrypt_control_s_axi is
    ...
    constant ADDR_LENGTH_R_DATA_1 : INTEGER := 16#1c#;
    ...
    signal int_key             : UNSIGNED(7 downto 0) := (others => '0');
            ...
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_KEY_DATA_0 =>
                        rdata_data <= RESIZE(int_key(7 downto 0), 32);
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_KEY_DATA_0) then
                    int_key(7 downto 0) <= (UNSIGNED(WDATA(7 downto 0)) and wmask(7 downto 0)) or ((not wmask(7 downto 0)) and int_key(7 downto 0));
                end if;
            end if;
        end if;
    end process;
