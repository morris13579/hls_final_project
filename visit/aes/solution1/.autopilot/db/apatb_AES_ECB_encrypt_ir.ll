; ModuleID = 'C:/Users/Morris/Desktop/HighLevelSynthesis_AES/visit/aes/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_AES_ECB_encrypt_ir(%"class.hls::stream"* %plain, %"class.hls::stream"* %encrypt, i8* %key, i64 %len) local_unnamed_addr #0 {
entry:
  ...
  call fastcc void @copy_in(%"class.hls::stream"* %plain, %"class.hls::stream"* nonnull align 512 %plain_copy1, %"class.hls::stream"* %encrypt, %"class.hls::stream"* nonnull align 512 %encrypt_copy2, [16 x i8]* %0, [16 x i8]* nonnull align 512 %key_copy)
  %1 = getelementptr inbounds [16 x i8], [16 x i8]* %key_copy, i32 0, i32 0
  call void @apatb_AES_ECB_encrypt_hw(%"class.hls::stream"* %plain_copy1, %"class.hls::stream"* %encrypt_copy2, i8* %1, i64 %len)
  call fastcc void @copy_out(%"class.hls::stream"* %plain, %"class.hls::stream"* nonnull align 512 %plain_copy1, %"class.hls::stream"* %encrypt, %"class.hls::stream"* nonnull align 512 %encrypt_copy2, [16 x i8]* %0, [16 x i8]* nonnull align 512 %key_copy)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512, [16 x i8]* readonly, [16 x i8]* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @onebyonecpy_hls.p0a16i8([16 x i8]* noalias align 512, [16 x i8]* noalias readonly) unnamed_addr #5 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512, [16 x i8]*, [16 x i8]* noalias readonly align 512) unnamed_addr #6 {
entry:
...
entry:
  ...
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1, [16 x i8]* null, [16 x i8]* %4)
  %5 = bitcast [16 x i8]* %4 to i8*
  call void @AES_ECB_encrypt_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream"* %1, i8* %5, i64 %3)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1, [16 x i8]* null, [16 x i8]* %4)
  ret void
}
