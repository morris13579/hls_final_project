...
entity AES_ECB_encrypt_control_s_axi is
generic (
...
end entity AES_ECB_encrypt_control_s_axi;
...
architecture behave of AES_ECB_encrypt_control_s_axi is
    ...
    component AES_ECB_encrypt_control_s_axi_ram is
        generic (
            BYTES   : INTEGER :=4;
            DEPTH   : INTEGER :=256;
            AWIDTH  : INTEGER :=8);
    ...
    end component AES_ECB_encrypt_control_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_key
int_key : AES_ECB_encrypt_control_s_axi_ram
generic map (
     BYTES    => 4,
     DEPTH    => 4,
     AWIDTH   => log2(4))
...
entity AES_ECB_encrypt_control_s_axi_ram is
    generic (
        BYTES   : INTEGER :=4;
        DEPTH   : INTEGER :=256;
        AWIDTH  : INTEGER :=8);
...
end entity AES_ECB_encrypt_control_s_axi_ram;

architecture behave of AES_ECB_encrypt_control_s_axi_ram is
