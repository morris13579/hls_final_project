...
// ==============================================================
`timescale 1 ns / 1 ps
module AES_ECB_encrypt_SubBytes58_sbox113_rom (
...
initial begin
    $readmemh("./AES_ECB_encrypt_SubBytes58_sbox113_rom.dat", ram0);
    $readmemh("./AES_ECB_encrypt_SubBytes58_sbox113_rom.dat", ram1);
    $readmemh("./AES_ECB_encrypt_SubBytes58_sbox113_rom.dat", ram2);
    $readmemh("./AES_ECB_encrypt_SubBytes58_sbox113_rom.dat", ram3);
    $readmemh("./AES_ECB_encrypt_SubBytes58_sbox113_rom.dat", ram4);
    $readmemh("./AES_ECB_encrypt_SubBytes58_sbox113_rom.dat", ram5);
    $readmemh("./AES_ECB_encrypt_SubBytes58_sbox113_rom.dat", ram6);
    $readmemh("./AES_ECB_encrypt_SubBytes58_sbox113_rom.dat", ram7);
end
...
`timescale 1 ns / 1 ps
module AES_ECB_encrypt_SubBytes58_sbox113(
    reset,
    clk,
    address0,
    ce0,
...
AES_ECB_encrypt_SubBytes58_sbox113_rom AES_ECB_encrypt_SubBytes58_sbox113_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
