...
entity AES_ECB_encrypt_sbox_1_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 8; 
...
architecture rtl of AES_ECB_encrypt_sbox_1_rom is 
...
entity AES_ECB_encrypt_sbox_1 is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of AES_ECB_encrypt_sbox_1 is
    component AES_ECB_encrypt_sbox_1_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    AES_ECB_encrypt_sbox_1_rom_U :  component AES_ECB_encrypt_sbox_1_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
