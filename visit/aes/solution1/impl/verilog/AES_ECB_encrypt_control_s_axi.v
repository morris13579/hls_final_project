...
// ==============================================================
`timescale 1ns/1ps
module AES_ECB_encrypt_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER        = 6'h08,
    ADDR_ISR        = 6'h0c,
    ADDR_LEN_DATA_0 = 6'h20,
    ADDR_LEN_DATA_1 = 6'h24,
    ADDR_LEN_CTRL   = 6'h28,
    ADDR_KEY_BASE   = 6'h10,
    ADDR_KEY_HIGH   = 6'h1f,
    WRIDLE          = 2'd0,
...
//------------------------Instantiation------------------
// int_key
AES_ECB_encrypt_control_s_axi_ram #(
    .BYTES    ( 4 ),
    .DEPTH    ( 4 )
) int_key (
    .clk0     ( ACLK ),
...
module AES_ECB_encrypt_control_s_axi_ram
#(parameter
    BYTES  = 4,
    DEPTH  = 256,
    AWIDTH = log2(DEPTH)
