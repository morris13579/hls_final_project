...
architecture behav of SubBytes78 is 
...
begin
    sbox_V_U : component SubBytes46_sbox_V88
    generic map (
        DataWidth => 8,
        AddressRange => 256,
        AddressWidth => 8)
    ...
    sbox_V_address0 <= tmp_2_fu_86_p1(8 - 1 downto 0);

    sbox_V_ce0_assign_proc : process(ap_CS_fsm_state3)
    begin
