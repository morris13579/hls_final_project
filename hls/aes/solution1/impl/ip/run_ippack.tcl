...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS plain_V_V encrypt_V_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
