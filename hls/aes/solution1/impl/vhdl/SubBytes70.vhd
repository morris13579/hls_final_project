...
architecture behav of SubBytes70 is 
    ...
    signal sbox_V82_address0 : STD_LOGIC_VECTOR (7 downto 0);
    signal sbox_V82_ce0 : STD_LOGIC;
    signal sbox_V82_q0 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    sbox_V82_U : component SubBytes46_sbox_V88
    generic map (
        DataWidth => 8,
        AddressRange => 256,
        AddressWidth => 8)
    ...
    sbox_V82_address0 <= tmp_2_fu_86_p1(8 - 1 downto 0);

    sbox_V82_ce0_assign_proc : process(ap_CS_fsm_state3)
    begin
