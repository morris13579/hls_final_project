...
architecture behav of SubBytes36 is 
...
begin
    sbox59_U : component SubBytes20_sbox63
    generic map (
        DataWidth => 8,
        AddressRange => 256,
        AddressWidth => 8)
    ...
    sbox59_address0 <= tmp_5_fu_86_p1(8 - 1 downto 0);

    sbox59_ce0_assign_proc : process(ap_CS_fsm_state3)
    begin
