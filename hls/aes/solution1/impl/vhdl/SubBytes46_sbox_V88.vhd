...
entity SubBytes46_sbox_V88_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 8; 
...
architecture rtl of SubBytes46_sbox_V88_rom is 
...
architecture arch of SubBytes46_sbox_V88 is
    component SubBytes46_sbox_V88_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    SubBytes46_sbox_V88_rom_U :  component SubBytes46_sbox_V88_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
