...
architecture behav of SubBytes44 is 
...
begin
    sbox57_U : component SubBytes20_sbox63
    generic map (
        DataWidth => 8,
        AddressRange => 256,
        AddressWidth => 8)
    ...
    sbox57_address0 <= tmp_5_fu_86_p1(8 - 1 downto 0);

    sbox57_ce0_assign_proc : process(ap_CS_fsm_state3)
    begin
