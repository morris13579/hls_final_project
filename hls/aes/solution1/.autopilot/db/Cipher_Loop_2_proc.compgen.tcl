...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename state_40 \
    op interface \
    ports { state_40_address0 { O 4 vector } state_40_ce0 { O 1 bit } state_40_q0 { I 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'state_40'"
}
}
