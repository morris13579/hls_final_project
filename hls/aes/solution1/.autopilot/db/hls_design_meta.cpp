...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("plain_V_V_TDATA", 8, hls_in, 0, "axis", "in_data", 1),
	Port_Property("plain_V_V_TVALID", 1, hls_in, 0, "axis", "in_vld", 1),
	Port_Property("plain_V_V_TREADY", 1, hls_out, 0, "axis", "in_acc", 1),
	Port_Property("encrypt_V_V_TDATA", 8, hls_out, 1, "axis", "out_data", 1),
	Port_Property("encrypt_V_V_TVALID", 1, hls_out, 1, "axis", "out_vld", 1),
	Port_Property("encrypt_V_V_TREADY", 1, hls_in, 1, "axis", "out_acc", 1),
