...
set C_modelName {MixColumns60}
set C_modelType { void 0 }
set C_modelArgList {
	{ in_V int 8 regular {array 16 { 1 1 } 1 1 }  }
	{ out_V int 8 regular {array 16 { 0 0 } 0 1 }  }
}
...
set portList { 
	...
	{ in_V_address1 sc_out sc_lv 4 signal 0 } 
	{ in_V_ce1 sc_out sc_logic 1 signal 0 } 
	{ in_V_q1 sc_in sc_lv 8 signal 0 } 
	...
	{ out_V_address1 sc_out sc_lv 4 signal 1 } 
	{ out_V_ce1 sc_out sc_logic 1 signal 1 } 
	{ out_V_we1 sc_out sc_logic 1 signal 1 } 
	{ out_V_d1 sc_out sc_lv 8 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_V_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "in_V", "role": "address1" }} , 
 	{ "name": "in_V_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_V", "role": "ce1" }} , 
 	{ "name": "in_V_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "in_V", "role": "q1" }} , 
 	...
 	{ "name": "out_V_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "out_V", "role": "address1" }} , 
 	{ "name": "out_V_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "out_V", "role": "ce1" }} , 
 	{ "name": "out_V_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "out_V", "role": "we1" }} , 
 	{ "name": "out_V_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "out_V", "role": "d1" }}  ]}
...
set Spec2ImplPortList { 
	in_V { ap_memory {  { in_V_address0 mem_address 1 4 }  { in_V_ce0 mem_ce 1 1 }  { in_V_q0 mem_dout 0 8 }  { in_V_address1 MemPortADDR2 1 4 }  { in_V_ce1 MemPortCE2 1 1 }  { in_V_q1 MemPortDOUT2 0 8 } } }
	out_V { ap_memory {  { out_V_address0 mem_address 1 4 }  { out_V_ce0 mem_ce 1 1 }  { out_V_we0 mem_we 1 1 }  { out_V_d0 mem_din 1 8 }  { out_V_address1 MemPortADDR2 1 4 }  { out_V_ce1 MemPortCE2 1 1 }  { out_V_we1 MemPortWE2 1 1 }  { out_V_d1 MemPortDIN2 1 8 } } }
}
