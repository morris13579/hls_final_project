...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "sbox60", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sbox60_U", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	SubBytes32 {
		...
		sbox60 {Type I LastRead -1 FirstWrite -1}}}
