...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "sbox56", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sbox56_U", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	SubBytes48 {
		...
		sbox56 {Type I LastRead -1 FirstWrite -1}}}
