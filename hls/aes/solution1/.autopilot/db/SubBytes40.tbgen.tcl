...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "sbox58", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sbox58_U", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	SubBytes40 {
		...
		sbox58 {Type I LastRead -1 FirstWrite -1}}}
