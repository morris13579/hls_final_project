...
entity KeyExpansion_sbox_1_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 8; 
...
architecture rtl of KeyExpansion_sbox_1_rom is 
...
architecture arch of KeyExpansion_sbox_1 is
    component KeyExpansion_sbox_1_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    KeyExpansion_sbox_1_rom_U :  component KeyExpansion_sbox_1_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
