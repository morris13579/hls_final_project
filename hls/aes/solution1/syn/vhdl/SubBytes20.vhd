...
architecture behav of SubBytes20 is 
...
begin
    sbox63_U : component SubBytes20_sbox63
    generic map (
        DataWidth => 8,
        AddressRange => 256,
        AddressWidth => 8)
    ...
    sbox63_address0 <= tmp_5_fu_86_p1(8 - 1 downto 0);

    sbox63_ce0_assign_proc : process(ap_CS_fsm_state3)
    begin
