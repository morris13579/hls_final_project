...
entity SubBytes20_sbox63_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 8; 
...
architecture rtl of SubBytes20_sbox63_rom is 
...
architecture arch of SubBytes20_sbox63 is
    component SubBytes20_sbox63_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    SubBytes20_sbox63_rom_U :  component SubBytes20_sbox63_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
