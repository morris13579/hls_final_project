...
#ifndef _SubBytes58_HH_
#define _SubBytes58_HH_
...
struct SubBytes58 : public sc_module {
    ...
    // Module declarations
    SubBytes58(sc_module_name name);
    SC_HAS_PROCESS(SubBytes58);

    ~SubBytes58();

    sc_trace_file* mVcdFile;

    SubBytes46_sbox_V88* sbox_V85_U;
    sc_signal< sc_logic > ap_done_reg;
    sc_signal< sc_lv<4> > ap_CS_fsm;
    sc_signal< sc_logic > ap_CS_fsm_state1;
    sc_signal< sc_lv<8> > sbox_V85_address0;
    sc_signal< sc_logic > sbox_V85_ce0;
    sc_signal< sc_lv<8> > sbox_V85_q0;
    ...
    void thread_sbox_V85_address0();
    void thread_sbox_V85_ce0();
