...
#ifndef _SubBytes24_HH_
#define _SubBytes24_HH_
...
struct SubBytes24 : public sc_module {
    ...
    // Module declarations
    SubBytes24(sc_module_name name);
    SC_HAS_PROCESS(SubBytes24);

    ~SubBytes24();

    sc_trace_file* mVcdFile;

    SubBytes20_sbox63* sbox62_U;
    sc_signal< sc_logic > ap_done_reg;
    sc_signal< sc_lv<4> > ap_CS_fsm;
    sc_signal< sc_logic > ap_CS_fsm_state1;
    sc_signal< sc_lv<8> > sbox62_address0;
    sc_signal< sc_logic > sbox62_ce0;
    sc_signal< sc_lv<8> > sbox62_q0;
    ...
    void thread_sbox62_address0();
    void thread_sbox62_ce0();
