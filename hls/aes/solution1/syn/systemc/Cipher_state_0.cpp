...
void Cipher_state_0::proc_count() {
    if (reset.read() == SC_LOGIC_1) {
        count.write(0);
...
void Cipher_state_0::proc_full_n() {
    if (reset.read() == SC_LOGIC_1) {
...
void Cipher_state_0::proc_empty_n() {
    if (reset.read() == SC_LOGIC_1) {
