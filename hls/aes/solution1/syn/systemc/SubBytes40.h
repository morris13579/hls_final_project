...
#ifndef _SubBytes40_HH_
#define _SubBytes40_HH_
...
struct SubBytes40 : public sc_module {
    ...
    // Module declarations
    SubBytes40(sc_module_name name);
    SC_HAS_PROCESS(SubBytes40);

    ~SubBytes40();

    sc_trace_file* mVcdFile;

    SubBytes20_sbox63* sbox58_U;
    sc_signal< sc_logic > ap_done_reg;
    sc_signal< sc_lv<4> > ap_CS_fsm;
    sc_signal< sc_logic > ap_CS_fsm_state1;
    sc_signal< sc_lv<8> > sbox58_address0;
    sc_signal< sc_logic > sbox58_ce0;
    sc_signal< sc_lv<8> > sbox58_q0;
    ...
    void thread_sbox58_address0();
    void thread_sbox58_ce0();
