...
#ifndef _SubBytes36_HH_
#define _SubBytes36_HH_
...
struct SubBytes36 : public sc_module {
    ...
    // Module declarations
    SubBytes36(sc_module_name name);
    SC_HAS_PROCESS(SubBytes36);

    ~SubBytes36();

    sc_trace_file* mVcdFile;

    SubBytes20_sbox63* sbox59_U;
    sc_signal< sc_logic > ap_done_reg;
    sc_signal< sc_lv<4> > ap_CS_fsm;
    sc_signal< sc_logic > ap_CS_fsm_state1;
    sc_signal< sc_lv<8> > sbox59_address0;
    sc_signal< sc_logic > sbox59_ce0;
    sc_signal< sc_lv<8> > sbox59_q0;
    ...
    void thread_sbox59_address0();
    void thread_sbox59_ce0();
