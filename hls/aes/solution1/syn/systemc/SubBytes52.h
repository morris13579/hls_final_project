...
#ifndef _SubBytes52_HH_
#define _SubBytes52_HH_
...
struct SubBytes52 : public sc_module {
    ...
    // Module declarations
    SubBytes52(sc_module_name name);
    SC_HAS_PROCESS(SubBytes52);

    ~SubBytes52();

    sc_trace_file* mVcdFile;

    SubBytes20_sbox63* sbox_U;
