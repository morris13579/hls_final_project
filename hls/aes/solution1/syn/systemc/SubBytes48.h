...
#ifndef _SubBytes48_HH_
#define _SubBytes48_HH_
...
struct SubBytes48 : public sc_module {
    ...
    // Module declarations
    SubBytes48(sc_module_name name);
    SC_HAS_PROCESS(SubBytes48);

    ~SubBytes48();

    sc_trace_file* mVcdFile;

    SubBytes20_sbox63* sbox56_U;
    sc_signal< sc_logic > ap_done_reg;
    sc_signal< sc_lv<4> > ap_CS_fsm;
    sc_signal< sc_logic > ap_CS_fsm_state1;
    sc_signal< sc_lv<8> > sbox56_address0;
    sc_signal< sc_logic > sbox56_ce0;
    sc_signal< sc_lv<8> > sbox56_q0;
    ...
    void thread_sbox56_address0();
    void thread_sbox56_ce0();
