...
#ifndef _SubBytes28_HH_
#define _SubBytes28_HH_
...
struct SubBytes28 : public sc_module {
    ...
    // Module declarations
    SubBytes28(sc_module_name name);
    SC_HAS_PROCESS(SubBytes28);

    ~SubBytes28();

    sc_trace_file* mVcdFile;

    SubBytes20_sbox63* sbox61_U;
    sc_signal< sc_logic > ap_done_reg;
    sc_signal< sc_lv<4> > ap_CS_fsm;
    sc_signal< sc_logic > ap_CS_fsm_state1;
    sc_signal< sc_lv<8> > sbox61_address0;
    sc_signal< sc_logic > sbox61_ce0;
    sc_signal< sc_lv<8> > sbox61_q0;
    ...
    void thread_sbox61_address0();
    void thread_sbox61_ce0();
