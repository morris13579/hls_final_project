...
#ifndef _Cipher_state_0_V_H_
#define _Cipher_state_0_V_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "Cipher_state_0_V_memcore.h"

SC_MODULE(Cipher_state_0_V) {
...
protected:
    ...
    Cipher_state_0_V_memcore* Cipher_state_0_V_memcore_U;
...
public:
    ~Cipher_state_0_V();
    SC_CTOR(Cipher_state_0_V) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        Cipher_state_0_V_memcore_U = new Cipher_state_0_V_memcore("Cipher_state_0_V_memcore_U");
        Cipher_state_0_V_memcore_U->clk      ( clk );
        Cipher_state_0_V_memcore_U->reset    ( reset );
        Cipher_state_0_V_memcore_U->ce0      ( i_ce0 );
        Cipher_state_0_V_memcore_U->we0      ( i_we0 );
        Cipher_state_0_V_memcore_U->address0 ( memcore_iaddr );
        Cipher_state_0_V_memcore_U->d0       ( i_d0 );
        Cipher_state_0_V_memcore_U->q0       ( i_q0 );

        Cipher_state_0_V_memcore_U->ce1      ( t_ce0 );
        Cipher_state_0_V_memcore_U->we1      ( t_we0 );
        Cipher_state_0_V_memcore_U->address1 ( memcore_taddr );
        Cipher_state_0_V_memcore_U->d1       ( t_d0 );
        Cipher_state_0_V_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "Cipher_state_0_V.trace");
            // ports
