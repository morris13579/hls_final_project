...
#ifndef _SubBytes78_HH_
#define _SubBytes78_HH_
...
struct SubBytes78 : public sc_module {
    ...
    // Module declarations
    SubBytes78(sc_module_name name);
    SC_HAS_PROCESS(SubBytes78);

    ~SubBytes78();

    sc_trace_file* mVcdFile;

    SubBytes46_sbox_V88* sbox_V_U;
