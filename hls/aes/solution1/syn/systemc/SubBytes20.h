...
#ifndef _SubBytes20_HH_
#define _SubBytes20_HH_
...
struct SubBytes20 : public sc_module {
    ...
    // Module declarations
    SubBytes20(sc_module_name name);
    SC_HAS_PROCESS(SubBytes20);

    ~SubBytes20();

    sc_trace_file* mVcdFile;

    SubBytes20_sbox63* sbox63_U;
    sc_signal< sc_logic > ap_done_reg;
    sc_signal< sc_lv<4> > ap_CS_fsm;
    sc_signal< sc_logic > ap_CS_fsm_state1;
    sc_signal< sc_lv<8> > sbox63_address0;
    sc_signal< sc_logic > sbox63_ce0;
    sc_signal< sc_lv<8> > sbox63_q0;
    ...
    void thread_sbox63_address0();
    void thread_sbox63_ce0();
