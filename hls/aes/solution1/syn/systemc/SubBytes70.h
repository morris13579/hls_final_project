...
#ifndef _SubBytes70_HH_
#define _SubBytes70_HH_
...
struct SubBytes70 : public sc_module {
    ...
    // Module declarations
    SubBytes70(sc_module_name name);
    SC_HAS_PROCESS(SubBytes70);

    ~SubBytes70();

    sc_trace_file* mVcdFile;

    SubBytes46_sbox_V88* sbox_V82_U;
    sc_signal< sc_logic > ap_done_reg;
    sc_signal< sc_lv<4> > ap_CS_fsm;
    sc_signal< sc_logic > ap_CS_fsm_state1;
    sc_signal< sc_lv<8> > sbox_V82_address0;
    sc_signal< sc_logic > sbox_V82_ce0;
    sc_signal< sc_lv<8> > sbox_V82_q0;
    ...
    void thread_sbox_V82_address0();
    void thread_sbox_V82_ce0();
