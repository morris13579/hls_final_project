...
#ifndef _SubBytes32_HH_
#define _SubBytes32_HH_
...
struct SubBytes32 : public sc_module {
    ...
    // Module declarations
    SubBytes32(sc_module_name name);
    SC_HAS_PROCESS(SubBytes32);

    ~SubBytes32();

    sc_trace_file* mVcdFile;

    SubBytes20_sbox63* sbox60_U;
    sc_signal< sc_logic > ap_done_reg;
    sc_signal< sc_lv<4> > ap_CS_fsm;
    sc_signal< sc_logic > ap_CS_fsm_state1;
    sc_signal< sc_lv<8> > sbox60_address0;
    sc_signal< sc_logic > sbox60_ce0;
    sc_signal< sc_lv<8> > sbox60_q0;
    ...
    void thread_sbox60_address0();
    void thread_sbox60_ce0();
