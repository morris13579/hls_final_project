...
const sc_lv<3> AddRoundKey::ap_ST_fsm_state1 = "1";
const sc_lv<3> AddRoundKey::ap_ST_fsm_state2 = "10";
const sc_lv<3> AddRoundKey::ap_ST_fsm_state3 = "100";
...
const sc_lv<5> AddRoundKey::ap_const_lv5_0 = "00000";
const sc_lv<32> AddRoundKey::ap_const_lv32_2 = "10";
const sc_lv<5> AddRoundKey::ap_const_lv5_10 = "10000";
...
void AddRoundKey::thread_out_V_address0() {
    out_V_address0 =  (sc_lv<4>) (tmp_s_reg_109.read());
}

void AddRoundKey::thread_out_V_ce0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
...
void AddRoundKey::thread_out_V_d0() {
    out_V_d0 = (RoundKey_V_q0.read() ^ in_V_q0.read());
}

void AddRoundKey::thread_out_V_we0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
