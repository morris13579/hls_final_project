...
#ifndef _SubBytes44_HH_
#define _SubBytes44_HH_
...
struct SubBytes44 : public sc_module {
    ...
    // Module declarations
    SubBytes44(sc_module_name name);
    SC_HAS_PROCESS(SubBytes44);

    ~SubBytes44();

    sc_trace_file* mVcdFile;

    SubBytes20_sbox63* sbox57_U;
    sc_signal< sc_logic > ap_done_reg;
    sc_signal< sc_lv<4> > ap_CS_fsm;
    sc_signal< sc_logic > ap_CS_fsm_state1;
    sc_signal< sc_lv<8> > sbox57_address0;
    sc_signal< sc_logic > sbox57_ce0;
    sc_signal< sc_lv<8> > sbox57_q0;
    ...
    void thread_sbox57_address0();
    void thread_sbox57_ce0();
