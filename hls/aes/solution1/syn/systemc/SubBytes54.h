...
#ifndef _SubBytes54_HH_
#define _SubBytes54_HH_
...
struct SubBytes54 : public sc_module {
    ...
    // Module declarations
    SubBytes54(sc_module_name name);
    SC_HAS_PROCESS(SubBytes54);

    ~SubBytes54();

    sc_trace_file* mVcdFile;

    SubBytes46_sbox_V88* sbox_V86_U;
    sc_signal< sc_logic > ap_done_reg;
    sc_signal< sc_lv<4> > ap_CS_fsm;
    sc_signal< sc_logic > ap_CS_fsm_state1;
    sc_signal< sc_lv<8> > sbox_V86_address0;
    sc_signal< sc_logic > sbox_V86_ce0;
    sc_signal< sc_lv<8> > sbox_V86_q0;
    ...
    void thread_sbox_V86_address0();
    void thread_sbox_V86_ce0();
