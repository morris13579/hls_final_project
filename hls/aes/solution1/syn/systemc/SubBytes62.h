...
#ifndef _SubBytes62_HH_
#define _SubBytes62_HH_
...
struct SubBytes62 : public sc_module {
    ...
    // Module declarations
    SubBytes62(sc_module_name name);
    SC_HAS_PROCESS(SubBytes62);

    ~SubBytes62();

    sc_trace_file* mVcdFile;

    SubBytes46_sbox_V88* sbox_V84_U;
    sc_signal< sc_logic > ap_done_reg;
    sc_signal< sc_lv<4> > ap_CS_fsm;
    sc_signal< sc_logic > ap_CS_fsm_state1;
    sc_signal< sc_lv<8> > sbox_V84_address0;
    sc_signal< sc_logic > sbox_V84_ce0;
    sc_signal< sc_lv<8> > sbox_V84_q0;
    ...
    void thread_sbox_V84_address0();
    void thread_sbox_V84_ce0();
